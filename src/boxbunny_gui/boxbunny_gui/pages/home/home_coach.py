...
from boxbunny_gui.theme import (
    Color, Size, badge_style, font, section_title_style,
    DANGER_BTN, GHOST_BTN, PRIMARY_BTN, SURFACE_BTN,
)
...
class HomeCoachPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._status_badge.setStyleSheet(badge_style())
        ...
        self._btn_back.clicked.connect(
            lambda: self._router.navigate("auth")
        )
        ...
        self._btn_start_station = BigButton(
            "Start Station", stylesheet=PRIMARY_BTN
        )
        ...
        presets_lbl.setStyleSheet(section_title_style())
        ...
        btn_row = QHBoxLayout()
        btn_row.setSpacing(Size.SPACING)
        ...
        self._btn_switch.clicked.connect(
            lambda: self._router.navigate("presets")
        )
    ...
    def _update_state(self) -> None:
        ...
        if self._session_active:
            ...
            badge_text = "Idle"
            badge_color = Color.TEXT_SECONDARY
        self._status_badge.setText(badge_text)
        self._status_badge.setStyleSheet(badge_style(badge_color))
        self._participant_lbl.setText(
            f"Participant #{self._participant_num}"
        )
